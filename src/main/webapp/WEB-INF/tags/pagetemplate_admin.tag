        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample03">
                <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                    <a class="nav-material nav-link" href="${pageContext.request.contextPath}/navToCustomerRequests">Kunde
                        bestillinger</a>
                    <a class="nav-material nav-link" href="${pageContext.request.contextPath}/navToCustomerOrders">Kunde
                        ordrer</a>
