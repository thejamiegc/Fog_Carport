    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="index.jsp">
                <img src="${pageContext.request.contextPath}/images/FOGLogo.jpg" width="100px;" class="img-fluid"/>
            </a>
...
<div class="container mt-3">
    ...
    <div class="row mt-4">
        <div class="col">
            <p>DAT 2.Sem Gruppe C - Vinter 2022 Eksamen </p>
        </div>
        <div class="col">
        </div>
        <div class="col">
            <p>Jamie, Isak, Helena, Andreas og Felicia</p>
        </div>
    </div>
