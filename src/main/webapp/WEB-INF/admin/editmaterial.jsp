    ...
    <jsp:body>
        ...
        <form action="updatematerial" method="get">
            <div class="mb-3">
                ...
                <input readonly type="number" id="materialID" name="materialID" class="form-control"
                       value="${sessionScope.material.materialID}">
                ...
                <input type="number" id="priceperunit" name="priceperunit" class="form-control"
                       value="${sessionScope.material.pricePerUnit}">

                <label for="typename" class="form-label">Type:</label>
                <input readonly type="text" id="typename" name="typename" class="form-control"
                       value="${sessionScope.material.typename}">
